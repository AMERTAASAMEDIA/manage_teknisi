            ...
            <CModalBody>
                <CForm class="row g-4">
                    ...
                    <div class="col-auto">
                        ...
                        <CFormInput type="text" placeholder="Kode" v-model="data.master_supplier_nama" />
                    </div>
                    <!-- Alamat supplier -->
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <!-- <CFormLabel for="inputPassword2" class="visually-hidden">Password</CFormLabel> -->
                        <CFormInput type="text" placeholder="Prioritas" v-model="data.master_supplier_alamat" />
                    </div>
                    <!-- Nama Toko  -->
                    <div class="col-auto">
                        <CFormInput type="text" value="Prioritas" readonly plain-text />
                    ...
                    <div class="col-auto">
                        <!-- <CFormLabel for="inputPassword2" class="visually-hidden">Password</CFormLabel> -->
                        <CFormInput type="text" placeholder="Prioritas" v-model="data.master_supplier_toko" />
                    </div>
                    <!-- Telepon  -->
                    <div class="col-auto">
