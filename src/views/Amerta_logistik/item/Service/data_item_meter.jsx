    ...
    methods: {
        ...
        async UploadGambar() {
            ...
            if (!this.files || this.files.length === 0) {
                ...
                formData.append('item_husble', this.detail_item.item_husble);
                this.$swal.fire({
        ...
        getdata() {
            Axios.get(allSource.getDataItemBySatuanMeter + this.$store.getters.Auth_domain + "/Meter").then((response) => {
