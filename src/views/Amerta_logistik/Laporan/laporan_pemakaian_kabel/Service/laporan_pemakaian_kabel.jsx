...
export default {
    ...
    methods: {
        ...
        getdata() {
            Axios.get(allSource.getDataTransaksiLogistikKeluarTypeKabel + this.$store.getters.Auth_domain + "/METER").then((response) => {
    ...
    computed: {
        ...
        FilterPost: function () {
            return this.paginated.filter((item) => {
                var search_nama = item.Tr_logistic_keluar_kode_transaksi.toLowerCase().includes(this.cari.toLowerCase());
